...
namespace DoAnASP1.Areas.Admin.Controllers
{
    ...
    public class HoaDonsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaHD,UserID,TongTien,MaCTHD")] HoaDon hoaDon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("MaHD,UserID,TongTien,MaCTHD")] HoaDon hoaDon)
        {
            if (id != hoaDon.MaHD)
            {
                return NotFound();
